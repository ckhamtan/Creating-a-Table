...
/* This script connects to the MySQL server, selects the database, 
and creates a table. */
...
title VARCHAR(100) NOT NULL, entry TEXT NOT NULL,date_entered DATETIME NOT NULL) CHARACTER SET utf8 ';
